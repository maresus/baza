...
from app.brand.config import FARM_INFO


 # FARM_INFO je brand-config driven
...
WEEKLY_MENUS = {
    4: {
        ...
        "courses": [
            ...
            {"wine": "Šumenjak Alter 2021 (suho)", "dish": "Krompir iz naše njive, zelenjavni pire, pohan pišek s kmetije Pesek, solatka iz vrta gospodinje Sare"},
            {"wine": "Greif Rumeni muškat 2024 (polsladko)", "dish": "Pohorska gibanica babice Marije ali domač jabolčni štrudl ali pita sezone, hišni sladoled"},
        ],
    },
    5: {
...
WEEKLY_INFO = {
    ...
    "min_people": 6,
    "contact": {"phone": "031 330 113", "email": "info@kmetijapodgoro.si"},
